      ...
      <div class="row">
        <div class="col-12 col-md-6">
          ...
          <div class="input-group">
            <input type="number" class="form-control <?php if ($validation->hasError('amount')) : ?>is-invalid<?php endif ?>" id="amount" name="amount" value="<?= $oldInput['amount'] ?? $fine['amount'] ?? ''; ?>" placeholder="5000" required>
